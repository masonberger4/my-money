...
- **Returned income (Mason, 2026-08-19)** is the mirror on the INCOME side:
  ...
  outflow. `txTypeLabel` renders it "Returned income", never plain "Income" on
  money leaving. Income stays DEPOSITORY-only in both directions.
